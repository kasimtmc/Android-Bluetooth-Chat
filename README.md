...
2. To start a conversation between two phones, one of the devices must act as a server. In this case, you can try to connect to nearby devices as a client or open a server and wait for connection requests from other devices.
